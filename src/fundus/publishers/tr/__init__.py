...
class TR(metaclass=PublisherGroup):
    Haberturk = Publisher(name="Haberturk", domain="https://www.haberturk.com/", parser=HaberturkParser, sources=[
        Sitemap(
    ...
    NTVTR = Publisher(name="NTVTR", domain="https://www.ntv.com.tr/", parser=NTVTRParser, sources=[
