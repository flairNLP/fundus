...
class OttawaCitizenParser(ParserProxy):
    class V1(NationalPostParser.V1_1):
        _paragraph_selector = XPath(
            ...
            "//div[@class='story-v2-content-element-inline']/*[self::ol or self::ul]/li"
        )
        _subheadline_selector = XPath(
            "//div[@class='story-v2-content-element-inline']/*[(self::h2 or self::h3) and not(re:test(string(), '(?i)^read the questions and answers'))] |"
