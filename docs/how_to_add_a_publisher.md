...
For example, if we want our parser to extract article titles, we first refer to the [attribute guidelines](attribute_guidelines.md) and look for an attribute that matches our expectations.
